    ...
    () => [
      ...
      },
      {
        ...
        accessorFn: (row, index) => {
          return row.DELIVERED_DATE === null
            ? ""
            : dateFormat(row.DELIVERED_DATE, "yyyy-mm-dd");
        },
        cell: (info) => info.getValue(),
      },
      {
        ...
        accessorFn: (row, index) => {
          return row.EXECUTION_DATE === null
            ? ""
            : dateFormat(row.EXECUTION_DATE, "yyyy-mm-dd");
        },
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ERROR_CONFLICT_NAME",
      ...
      {
        accessorKey: "UNEXERCISED_AMOUNT",
        header: "Хэрэгжээгүй биелэлтийн дүн (төгрөг)",
        accessorFn: (row, index) => (
          <div>
            <CurrencyInput
              id="input-example"
              defaultValue={row.UNEXERCISED_AMOUNT}
              decimalsLimit={2}
              decimalScale={2}
              disabled
              style={{ textAlign: "center", backgroundColor: "transparent" }}
                ...
                >
                  <img
                    ...
                    onClick={() => {
                      ...
                      localStorage.setItem("stat_bm9", JSON.stringify(row));
                    }}
                    width="14px"
                    height="14px"
                    alt=""
