...
function Excel() {
  ...
  const schema = [
    ...
    {
      column: "Сахилгын шийтгэл ногдуулсан огноо",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Сахилгын шийтгэлийн дугаар",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Албан шаардлагын бүрэн хэрэгжсэн дүн (төгрөг)",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Албан шаардлагын бүрэн хэрэгжээгүй дүн (төгрөг)",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
...
type Stat_m6 = {
  ...
  AUDIT_KOD: number;
  ALBAN_SHARDLGN_OGNOO: number;
  ALBAN_SHARDLGN_DUGR: string;
  TUHAIN_UDAZT_ESEH: string;
  HULEEN_OGSON_OGNOO: number;
  ZORCHIL_ARILGAH_OGNOO: number;
  ZORCHIL_ANGILL: string;
  ALBAN_SHARDLGIN_TOGROG: number;
  BAIGUULLAGIN_NER: string;
  REGISTER: number;
  TOSOW_ZAHIRGCH_ANGILL: string;
  ZORCHIL_GARGSAN_HATO_NER: string;
  ZORCHIL_GARGSAN_HUNII_ALBAN_TUSHL: string;
  BIELLT_HYNAGCH_A_TUSHAAL: string;
  AUDIT_HUWIIN_DUGR: number;
  SAHILGIIN_SHIITGL_NOGDL_OGNOO: number;
  SAHILGIN_SHIITGL_DUGAAR: number;
  ALBAN_SHARDLGIN_BURN_H_TOO: number;
  ALBAN_SH_BURN_HERGJSN_DUN: number;
};
...
function Mayagt_6() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_m6, any>[]>(
    () => [
      ...
      },
      {
        ...
        header: "Зөрчил гаргасан хүний албан тушаал овог, нэр",
        cell: (info) => info.getValue(),
      },
      {
      ...
      {
        accessorKey: "BIELLT_HYNAGCH_A_TUSHAAL",
        header: "Биелэлтийн хянагчийн албан тушаал",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "AUDIT_HUWIIN_DUGR",
        header: "Аудиторын хувийн дугаар",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "SAHILGIIN_SHIITGL_NOGDL_OGNOO",
        header: "Сахилгын шийтгэл ногдуулах огноо",
        cell: (info) => info.getValue(),
      },
      {
      ...
      },
      {
        ...
        header: "Албан шаардлагын бүрэн хэрэгжсэн тоо",
        cell: (info) => info.getValue(),
      },
      {
  ...
  let Stat_m6 = [{}];
  const [data, setData] = React.useState<Stat_m6[]>(Stat_m6);
  ...
  //               className="font-medium"
  //               key={
  //                 "1. Албан шаардлага, төлбөрийн актыг хугацаанд нь биелүүлэх"
  //               }
  //               value={1}
  //             >
  //               {"1. Албан шаардлага, төлбөрийн актыг хугацаанд нь биелүүлэх"}
  ...
  //             <option
  //               className="font-medium"
  //               key={"2. Аудитын үйл ажилгаанд саад учруулсан"}
  //               value={2}
  //             >
  //               {"2. Аудитын үйл ажилгаанд саад учруулсан"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={"3. Санхүүгийн тайлангийн аудитаар сөрөг дүгнэлт авсан"}
  //               value={3}
  //             >
  //               {"3. Санхүүгийн тайлангийн аудитаар сөрөг дүгнэлт авсан"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={"4. Хуулиар хориглосон үйл ажилгаа явуулсан"}
  //               value={4}
  //             >
  //               {"4. Хуулиар хориглосон үйл ажилгаа явуулсан"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={"5. Албан үүргээ биелүүлээгүй"}
  //               value={5}
  //             >
  //               {"5. Албан үүргээ биелүүлээгүй"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={"6. Албан тушаалын бүрэн эрхээ хэтрүүлсэн"}
  //               value={6}
  //             >
  //               {"6. Албан тушаалын бүрэн эрхээ хэтрүүлсэн"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={
  //                 "7. Төрлийн аудитын байгууллага санхүүгийн тайланд дүгнэлт өгөхөөс татгалзсан"
  //               }
  //               value={7}
  //             >
  //               {
  ...
  //             </option>
  //           </select>
  //         ) : cell.id === "TOLOWLH_DANSNI_TOROL_TOGROG" ? (
  //           <select
  //             className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
  //             onChange={(text) => {
  //               let any = setFilter;
  ...
  //               {"Сонгоно уу"}
  //             </option>
  //             <option className="font-medium" key={"Улсын төсөвт"} value={1}>
  //               {"Улсын төсөвт"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={"Орон нутгийн төсөвт"}
  //               value={2}
  //             >
  //               {"Орон нутгийн төсөвт"}
  //             </option>
  //             <option
  //               className="font-medium"
  //               key={"Тухайн байгууллагад"}
  //               value={3}
  //             >
  //               {"Тухайн байгууллагад"}
  //             </option>
  //             <option className="font-medium" key={"Бусад"} value={4}>
  //               {"Бусад"}
  //             </option>
  //             <option
  //               className="font-medium"
  ...
  //           </select>
  //         ) : cell.id === "AUDIT_ON" ||
  //           cell.id === "ALBAN_SHARDLGN_OGNOO" ||
  //           cell.id === "HULEEN_OGSON_OGNOO" ||
  //           cell.id === "ZORCHIL_ARILGAH_OGNOO" ||
  //           cell.id === "BURTGELEES_HASAGDSN_OGNOO" ||
  //           cell.id === "SAHILGIIN_SHIITGL_NOGDL_OGNOO" ||
  //           cell.id === "ZORCHIL_ARILGH_BARIMT_OGNOO" ? (
  //           <input
  //             type="date"
  //             className="border-gray-400 rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2 font-normal"
  ...
  return (
    <>
      ...
      >
        <Title
          title={
            "САХИЛГЫН ШИЙТГЭЛ НОГДУУЛАХ АЛБАН ШААРДЛАГЫН БҮРТГЭЛ З-ТАББМ-6"
          }
          widthS={"32rem"}
          widthL={"16rem"}
        />
