...
function Excel() {
  ...
  const schema = [
    ...
    {
      column: "Алдаа, зөрчлийн дэд ангилал",
      wrap: true,
      sticky: "left",
      width: 30,
      type: String,
    ...
    {
      column: "Зөвлөмж хүргүүлсэн огноо",
      wrap: true,
      sticky: "left",
      width: 30,
      type: String,
    ...
    {
      column: "Биелсэн зөвлөмжийн дүн (төгрөг)",
      wrap: true,
      sticky: "left",
      width: 30,
      type: String,
    ...
    {
      column: "Дараагийн тайлант хугацаанд шилжих үлдэгдлийн дүн (төгрөг)",
      wrap: true,
      sticky: "left",
      width: 35,
      type: String,
...
type Stat_m4 = {
  ...
  AUDIT_KOD: number;
  ZORCHIL_T_UTGA: string;
  TUHAIN_UR_DUN_AZT_ESEH: string;
  ZORCHIL_ARILGAH_OGNOO: string;
  ZORCHIL_ANGILAL: string;
  ZOWLOMJ_HURGUULSEN_OGNOO: string;
  BIELELTIIN_TOOTSOH_OGNOO: string;
  ZOWLOMJ_UTGA: string;
  ZOWLOMJ_DUN_TOG: number;
  BAIGUULGIN_NR: string;
  REGISTER: number;
  TOSOW_ZAHIRGCH_ANGILL: string;
  BIELLTIIN_HYNAGCH_OVOG_NR: string;
  AUDITOR_HWN_DUGR: number;
  ZORCHIL_ARILGSN_BARIMT_OGNOO: number;
  BIELSN_ZOWLOMJ_DUN_TOG: number;
  DARAAGIIN_TAILMT_TIME: number;
  HUGATSA_TOLOW: string;
  UR_OGOOJ_TOOTSOH_ESEH: string;
  UR_OGOOJ_TOROL: string;
  HULEEN_ZOWSHOORUULSN_SANHUU_UR_TOO: number;
  HULEEN_ZOWSHRUULSN_SANHUU_DUN_TOG: number;
  HULEEN_ZOW_SAN_OGIIJN_TOO: number;
...
function Mayagt_4() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_m4, any>[]>(
    () => [
      {
      ...
      {
        accessorKey: "ALDAA_ZORCHIL_ANGILAL",
        header: "Алдаа, зөрчлийн дэд ангилал",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJ_HURGUULSEN_OGNOO",
      ...
      {
        accessorKey: "ZOWLOMJ_UTGA",
        header: "Зөвлөмжийн утга",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJ_DUN_TOG",
        header: "Зөвлөмжийн дүн (төгрөг)",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "BAIGUULLGIN_NR",
      ...
      {
        accessorKey: "BIELLTIIN_HYNAGCH_OVOG_NR",
        header: "Биелэлтийн хянагчийн овог, нэр",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "AUDITOR_HWN_DUGR",
        header: "Аудиторын хувийн дугаар",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZORCHIL_ARILGSN_BARIMT_OGNOO",
        header: "Зөрчлийг арилгасан баримтын огноо",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "BIELSN_ZOWLOMJ_DUN_TOG",
      ...
      {
        accessorKey: "UR_OGOOJ_TOOTSOH_ESEH",
        header: "Үр өгөөжийг тооцох эсэх",
        cell: (info) => info.getValue(),
      },
      {
      ...
      {
        accessorKey: "HULEEN_ZOWSHOORUULSN_SANHUU_UR_TOO",
        header: "Хүлээн зөвшөөрүүлсэн санхүүгийн үр өгөөжийн тоо",
        cell: (info) => info.getValue(),
      },

      {
        accessorKey: "HULEEN_ZOWSHRUULSN_SANHUU_DUN_TOG",
  ...
  let Stat_m4 = [{}];
  const [data, setData] = React.useState<Stat_m4[]>(Stat_m4);
  ...
  return (
    <>
      ...
      >
        <Title
          title={"ЗӨВЛӨМЖИЙН БҮРТГЭЛ З-ТАББМ-4"}
          widthS={"15rem"}
          widthL={"8rem"}
        />
