...
function Excel() {
  ...
  const schema = [
    ...
    {
      column: "Зөвлөмж өгсөн хугацаа /оноор/",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "ХШҮ хийсэн арга хэмжээний нэр",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Зөвлөмжийн мэдээллийн төрөл",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column:
        "Зөвлөмжийн хугацаа (Зөвхөн зөвлөмж биелсэн эсэх дээр үгүй гэж сонгосон тохиолдолд сонгоно.) ",
      wrap: true,
      width: 40,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Шийдвэрлэгдсэн өргөдөл гомдлын тоо",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Зөвлөмжийн хэрэгжээгүй шалтгааны тайлбар",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
...
type Stat_m14 = {
  ...
  SURGALZOWLOMJ_OGSON_HUGATSAATIIN_ORCHIN: string;
  HSHU_HIISEN_ARGA_HEMJEENII_NR: string;
  ZOWLOMJIIN_UTGA: string;
  ZOWLOMJIIN_MEDEELEL_TOROL: string;
  ZOWLOMJ_BIELSEN_ESEH: string;
  ZOWLOMJ_HUGATSAA: string;
  SHIIDWERLEGDSEN_ORGODOL_GOMDOL_TOO: string;
...
function Mayagt_14() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_m14, any>[]>(
    () => [
      ...
      {
        accessorKey: "ZOWLOMJ_OGSON_HUGATSAA",
        header: "Зөвлөмж өгсөн хугацаа /оноор/",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "HSHU_HIISEN_ARGA_HEMJEENII_NR",
        header: "ХШҮ хийсэн арга хэмжээний нэр",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJIIN_UTGA",
        header: "Зөвлөмжийн утга",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJIIN_MEDEELEL_TOROL",
        header: "Зөвлөмжийн мэдээллийн төрөл",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJ_BIELSEN_ESEH",
        header: "Зөвлөмж биелсэн эсэх",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJ_HUGATSAA",
        header:
          "Зөвлөмжийн хугацаа (Зөвхөн зөвлөмж биелсэн эсэх дээр үгүй гэж сонгосон тохиолдолд сонгосон.)",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "SHIIDWERLEGDSEN_ORGODOL_GOMDOL_TOO",
        header: "Шийдвэрлэгдсэн  өргөдөл гомдлын  тоо",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "ZOWLOMJ_HEREGJEEGUI_SHALTGAAN_TAILBAR",
  ...
  let Stat_m14 = [{}];
  const [data, setData] = React.useState<Stat_m14[]>(Stat_m14);
  ...
  function Draw_input(param: any, cell: any, index: number) {
    return (
      <div>
        {cell.id === "TORIIN_AUDIT_BAI" ? (
        ...
        ) : cell.id === "ZOWLOMJIIN_MEDEELEL_TOROL" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            {/* <option
              className="font-medium"
              key={"Төсөв, түүний зарцуулалттай холбоотой"}
              value={1}
            >
              {"Төсөв, түүний зарцуулалттай холбоотой"}
            </option>
            <option
              className="font-medium"
              key={"Хүний нөөцтэй холбоотой"}
              value={2}
            >
            ...
            <option
              className="font-medium"
              key={"Төлөвлөгөөт ажлын биелэлттэй холбоотой"}
              value={3}
            >
              {"Төлөвлөгөөт ажлын биелэлттэй холбоотой"}
            </option>
            <option className="font-medium" key={"Бусад"} value={3}>
              {"Бусад"}
            </option> */}
          </select>
        ) : cell.id === "ZOWLOMJ_BIELSEN_ESEH" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            <option className="font-medium" key={"Биелсэн"} value={1}>
              {"Биелсэн"}
            </option>
            <option className="font-medium" key={"Биелээгүй"} value={2}>
              {"Биелээгүй"}
            </option>
          </select>
        ) : cell.id === "ZOWLOMJ_HUGATSAA" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            {/* <option className="font-medium" key={"Хугацаа болоогүй"} value={1}>
              {"Хугацаа болоогүй"}
            </option>
            <option className="font-medium" key={"Хугацаа хэтэрсэн"} value={2}>
              {"Хугацаа хэтэрсэн"}
            </option> */}
          </select>
        ) : cell.id === "" || cell.id === "" ? (
