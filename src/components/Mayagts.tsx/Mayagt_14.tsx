...
function Excel() {
  ...
  const schema = [
    ...
    {
      column: "Тайлангийн хуудасны тоо             / Хураангуй /",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Тайлангийн хуудасны тоо             / Дэлгэрэнгүй /",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Тайлангийн хуудасны тоо              / Визуал /",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хэвлэсэн тоо                              / Дэлгэрэнгүй /",
      wrap: true,
      width: 28,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Цахимаар мэдээлсэн эсэх             / Хурангуй /",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Цахимаар мэдээлсэн эсэх            / Дэлгэрэнгүй /",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Цахимаар мэдээлсэн эсэх             / Визуал /",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
