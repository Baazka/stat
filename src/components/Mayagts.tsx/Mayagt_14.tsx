...
function Mayagt_14(props: any) {
  ...
  function CustomCell({
    ...
    if (
      id === "REPORTED_ABSTRACT_ID" ||
      id === "REPORTED_VISUAL_ID" ||
      id === "REPORTED_MORE_ID"
    ) {
      return (
        <select
      ...
      id === "PAGE_ABSTRACT_COUNT" ||
      id === "PAGE_MORE_COUNT" ||
      id === "PAGE_VISUAL_COUNT" ||
      id === "PRINT_ABSTRACT_COUNT" ||
      id === "PRINT_MORE_COUNT" ||
      id === "PRINT_VISUAL_COUNT"
    ) {
      return (
        <CurrencyInput
            ...
            <div className="flex justify-start" style={{ width: "80px" }}>
              {check_save(status) ? (
                <>
                  ...
                  <button
                    className="bg-transparent text-xs"
                    onClick={() => deleteRowFunc(index, row)}
                    type="button"
                    style={{
                      padding: "2px",
                      boxShadow: "0px 0px 0px 1px rgba(	38,132,254,0.3)",
