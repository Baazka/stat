...
function Excel() {
  ...
  const schema = [
    ...
    {
      column: "Хууль хяналтын байгууллагад шилжүүлсэн эсэх",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хууль хяналтын байгууллагад шилжүүлээгүй асуудлын дүн (төгрөг)",
      wrap: true,
      width: 35,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хууль хяналтын байгууллагад шилжүүлээгүй шалтгаан",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хууль хяналтын байгууллагад шилжүүлсэн асуудлын дүн (төгрөг)",
      wrap: true,
      width: 35,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Шилжүүлсэн байгууллагын нэр",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хууль хяналтын байгууллагаар бүрэн шийдвэрлэгдсэн дүн (төгрөг)",
      wrap: true,
      width: 35,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хууль хяналтын байгууллагаар хянагдаж байгаа дүн (төгрөг)",
      wrap: true,
      width: 35,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Хууль хяналтын байгууллагаар хэрэгсэхгүй болсон дүн (төгрөг)",
      wrap: true,
      width: 35,
      type: String,
      value: (student: any) => student.Name,
...
type Stat_m8 = {
  ...
  TOWCH_UTGA: string;
  ALDAA_ZORCHIL_ANGILL: string;
  HUULI_HBSHE: string;
  HUULI_HBSHA_DUN_T: number;
  HUULI_HBSH_SHALTGAAN: string;
  HUUL_HBSHA_DUN_T: number;
  SHILJUULSEN_BAIGUULGGIN_NER: string;
  ALBAN_BICHGIIN_DUGR: number;
  BAIGUULLAGIN_NR: string;
  REGISTER: number;
  TOSOW_ZAHIRGCH_ANGILL: string;
  ZORCHIL_GARGSAN_ATO_NER: string;
  ZORCHIL_GHA_TUSHAAL: string;
  HUULI_HBBSH_TOO: number;
  HUULI_HBHB_DUN_TOG: number;
  HUULI_HBHBD_TOG: number;
};
...
function Mayagt_8() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_m8, any>[]>(
    () => [
      {
      ...
      },
      {
        ...
        header:
          "Хууль хяналтын байгууллагад шилжүүлээгүй асуудлын дүн (төгрөг)",
        cell: (info) => info.getValue(),
      },
      {
  ...
  let Stat_m8 = [{}];
  const [data, setData] = React.useState<Stat_m8[]>(Stat_m8);
  ...
  return (
    <>
      ...
      >
        <Title
          title={
            "ХУУЛЬ ХЯНАЛТЫН БАЙГУУЛЛАГАД ШИЛЖҮҮЛСЭН АСУУДЛЫН БҮРТГЭЛ З-ТАББМ-8"
          }
          widthS={"37rem"}
          widthL={"14rem"}
        />
