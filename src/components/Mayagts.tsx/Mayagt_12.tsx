...
function Excel() {
  ...
  const schema = [
    ...
    {
      column: "Төрийн албан хаагчийн овог, нэр",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Төрийн аудитын байгууллагад ажилласан жил",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Мэргэжил /Үндсэн мэргэжил/",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Шилжилт хөдөлгөөний төрөл",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
    ...
    {
      column: "Шилжилт хөдөлгөөний шалтгаан",
      wrap: true,
      width: 30,
      type: String,
      value: (student: any) => student.Name,
...
type Stat_m12 = {
  ...
  TORIIN_ALBAN_HAAGCH_OVOG_NR: string;
  REGISTER: string;
  TORSON_ON_SAR_ODR: string;
  NAS: string;
  NASNII_BULEG: string;
  HUIS: string;
  ALBAN_TUSHAAL_TUWSHIN: string;
  TORIIN_AUDIT_BAI_AJILSAN_JL: string;
  BOLOWSROLIIN_TUWSHIN: string;
  MERGEJIL: string;
  SHILJILT_HODOLGOONII_TOROL: string;
  SHILJILT_HODOLGOONII_SHALTGAN: string;
};
...
function Mayagt_12() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_m12, any>[]>(
    () => [
      ...
      {
        accessorKey: "TORIIN_ALBAN_HAAGCH_OVOG_NR",
      ...
      {
        accessorKey: "ALBAN_TUSHAAL_TUWSHIN",
      ...
      {
        accessorKey: "BOLOWSROL_TUWSHIN",
        header: "Боловсролын түвшин",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "MERGEJIL",
        header: "Мэргэжил /Үндсэн мэргэжил/",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "SHILJILT_HODOLGOONII_TOROL",
        header: "Шилжилт хөдөлгөөний төрөл",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "SHILJILT_HODOLGOONII_SHALTGAN",
  ...
  let Stat_m12 = [{}];
  const [data, setData] = React.useState<Stat_m12[]>(Stat_m12);
      ...
      <div>
        {cell.id === "TORIIN_AUDIT_BAI" ? (
          ...
          >
            ...
            {/* <option className="font-medium" key={"Эрэгтэй"} value={1}>
              {"Эрэгтэй"}
            </option>
            <option className="font-medium" key={"Эмэгтэй"} value={2}>
              {"Эмэгтэй"}
            </option> */}
          </select>
        ) : cell.id === "ALBAN_TUSHAALIN_TUWSHIN" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            {/* <option className="font-medium" key={"Удирдах ажилтан"} value={1}>
              {"Удирдах ажилтан"}
            </option>
            <option className="font-medium" key={"Менежер"} value={2}>
              {"Менежер"}
            </option>
            <option className="font-medium" key={"Ахлах аудитор"} value={3}>
              {"Ахлах аудитор"}
            </option>
            <option className="font-medium" key={"16, түүнээс жил"} value={4}>
              {"16, түүнээс жил"}
            </option> */}
          </select>
        ) : cell.id === "TORIIN_AUDIT_BAI_A_J" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            {/* <option className="font-medium" key={"Доктор"} value={1}>
              {"Доктор"}
            </option>
            <option className="font-medium" key={"Магистр"} value={2}>
              {"Магистр"}
            </option>
            <option className="font-medium" key={"Бакалавр"} value={3}>
              {"Бакалавр"}
            </option>
            <option className="font-medium" key={"Дипломын дээд"} value={4}>
              {"Дипломын дээд"}
            </option>
            <option
              className="font-medium"
              key={"Тусгай мэргэжлийн дунд"}
              value={5}
            >
            ...
            <option
              className="font-medium"
              key={"Техникийн болон мэргэжлийн"}
              value={6}
            >
            ...
            <option
              className="font-medium"
              key={"Бүрэн дунд, түүнээс доош"}
              value={7}
            >
              {"Бүрэн дунд, түүнээс доош"}
            </option> */}
          </select>
        ) : cell.id === "BOLOWSROL_TUWSHIN" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            {/* <option className="font-medium" key={"Нягтлан бодогч"} value={1}>
              {"Нягтлан бодогч"}
            </option>
            <option className="font-medium" key={"Санхүүч"} value={2}>
              {"Санхүүч"}
            </option>
            <option className="font-medium" key={"Эдийн засагч"} value={3}>
              {"Эдийн засагч"}
            </option>
            <option className="font-medium" key={"Эрхзүйч"} value={4}>
              {"Эрхзүйч"}
            </option>
            <option className="font-medium" key={"Инжинер"} value={5}>
              {"Инжинер"}
            </option>
            <option className="font-medium" key={"Бусад"} value={6}>
              {"Бусад"}
            </option> */}
          </select>
        ) : cell.id === "MERGEJIL" ? (
          ...
          >
            ...
            {/* <option className="font-medium" key={"Ажилд томилогдсон"} value={1}>
              {"Ажилд томилогдсон"}
            </option>
            <option
              className="font-medium"
              key={"Ажлаас чөлөөлөгдсөн"}
              value={2}
            >
              {"Ажлаас чөлөөлөгдсөн"}
            </option> */}
          </select>
        ) : cell.id === "SHILJILT_HODOLGOONII_TOROL" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          >
            ...
            <option
              className="font-medium"
              key={"Байгууллага хооронд шилжсэн"}
              value={2}
            >
              {"Байгууллага хооронд шилжсэн"}
            </option>
            <option className="font-medium" key={"Эргүүлэн томилсон"} value={3}>
              {"Эргүүлэн томилсон"}
            </option>
            <option
              className="font-medium"
              key={"Өөрийн хүсэлтээр чөлөөлөгдсөн"}
              value={4}
            >
              {"Өөрийн хүсэлтээр чөлөөлөгдсөн"}
            </option>
            <option className="font-medium" key={"Тэтгэвэрт гарсан"} value={5}>
              {"Тэтгэвэрт гарсан"}
            </option>
            <option className="font-medium" key={"Нас барсан"} value={6}>
              {"Нас барсан"}
            </option>
            <option
              className="font-medium"
              key={"Жирэмсний болон хүүхэд асрах чөлөө авсан"}
              value={7}
            >
              {"Жирэмсний болон хүүхэд асрах чөлөө авсан"}
            </option>
            <option
              className="font-medium"
              key={"Гэрээ дуусгавар болсон"}
              value={8}
            >
              {"Гэрээ дуусгавар болсон"}
            </option>
            <option
              className="font-medium"
              key={"Бусад шалтгаанаар ажлаас чөлөөлөгдсөн"}
              value={9}
            >
              {"Бусад шалтгаанаар ажлаас чөлөөлөгдсөн"}
            </option> */}
          </select>
        ) : cell.id === "SHILJILT_HODOLGOONII_SHALTGAN" ? (
          <select
            className="border rounded text-sm focus:outline-none py-1 h-8 mr-1 inputRoundedMetting pl-2"
            onChange={(text) => {
              let any = setFilter;
          ...
          cell.id === "TORIIN_ALBAN_HAAGCH_OVOG_NR" ? (
          <textarea
  ...
  return (
    <>
      ...
      >
        <Title
          title={"ТӨРИЙН АУДИТЫН БАЙГУУЛЛАГЫН ХҮНИЙ НӨӨЦ З-ТАББМ-12"}
          widthS={"29rem"}
          widthL={"10rem"}
        />
