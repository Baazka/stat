...
function Mayagt_13(props: any) {
  ...
  const columns = React.useMemo(
    () => [
      ...
      {
        accessorKey: "TRAIN_ENVIRONMENT_NAME",
        header: "Сургалтын орчин",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "TRAIN_CATEGORY_NAME",
        header: "Сургалтын ангилал",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "TRAIN_DIRECTION_NAME",
      ...
      {
        accessorKey: "TRAIN_START_DATE",
        header: "Сургалт эхэлсэн огноо",
        accessorFn: (row, index) => {
          return row.TRAIN_START_DATE === null
            ? ""
            : dateFormat(row.TRAIN_START_DATE, "yyyy-mm-dd");
        },
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "TRAIN_END_DATE",
        header: "Сургалт дууссан огноо",
        accessorFn: (row, index) => {
          return row.TRAIN_END_DATE === null
            ? ""
            : dateFormat(row.TRAIN_END_DATE, "yyyy-mm-dd");
        },
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "TRAIN_MINUTE",
        header: "Сургалтын нийц цаг /минут/",
        cell: (info) => info.getValue(),
      },
      {
        accessorKey: "TRAIN_PERSON_COUNT",
                ...
                >
                  <img
                    ...
                    onClick={() => {
                      ...
                      localStorage.setItem("stat_bm13", JSON.stringify(row));
                    }}
                    width="14px"
                    height="14px"
                    alt=""
