...
function Mayagt_11_Create(props: any) {
  ...
  const [data, loadData] = useState({
    ...
    BUDGET_NAME:"",
    BUDGET_LEVEL_ID:999,
    CONCLUSION_FORM_ID:999,
    IS_REFLECT:999, //1-YES, 2- NO
    CONCLUSION_TYPE_ID:999,
    BENEFIT_TYPE_ID:999,
    BENEFIT_FIN_AMOUNT:0,
    BENEFIT_NONFIN_AMOUNT:0,
  ...
  async function fetchData() {
     ...
     if (localStorage.getItem('stat_bm8a') !== undefined && localStorage.getItem('stat_bm8a') !== null) {
      console.log(JSON.parse(localStorage.getItem('stat_bm8a')),'test');
      loadData({...JSON.parse(localStorage.getItem('stat_bm8a'))})
    ...
    let refBudgetLevel = await axios(Stat_Url + "refBudgetLevel");
    if (refBudgetLevel.data !== undefined && refBudgetLevel.data.length > 0) {
      let temp = drop;
      temp.drop2 = refBudgetLevel.data;
      setDrop({ ...temp });
    }
    let refConclusionForm = await axios(Stat_Url + "refConclusionForm");
    if (refConclusionForm.data !== undefined && refConclusionForm.data.length > 0) {
      let temp = drop;
      temp.drop3 = refConclusionForm.data;
      setDrop({ ...temp });
    }
    let refConclusionType = await axios(Stat_Url + "refConclusionType");
    if (refConclusionType.data !== undefined && refConclusionType.data.length > 0) {
      let temp = drop;
      temp.drop4 = refConclusionType.data;
      setDrop({ ...temp });
    }
    let refBenefitType = await axios(Stat_Url + "refBenefitType");
    if (refBenefitType.data !== undefined && refBenefitType.data.length > 0) {
      let temp = drop;
      temp.drop5 = refBenefitType.data;
      setDrop({ ...temp });
    }
  ...
  function requiredField(){
   if(data.DEPARTMENT_ID === 999){
    ...
    return false;
   }else if(data.BUDGET_LEVEL_ID === 999){
    alert('Төсвийн төрөл эсэх сонгоно уу')
    return false;
   }else if(data.CONCLUSION_FORM_ID === 999){
    alert('Дүгнэлтийн хэлбэр сонгоно уу')
    return false;
   }else if(data.IS_REFLECT === 999){
    alert('Тусгасан эсэх сонгоно уу')
    return false;
   }else if(data.CONCLUSION_TYPE_ID === 999){
    alert('Дүгнэлтийн төрөл сонгоно уу')
    return false;
   }else if(data.BENEFIT_TYPE_ID === 999){
    alert('Үр өгөөжийн төрөл сонгоно уу')
    return false;
   }
   else if(data.BUDGET_NAME === '' || data.BUDGET_NAME === null ){
    alert('Төсвийн нэр оруулна уу')
    return false;
   }
   else {
    return true
          ...
          <div className="flex  md:justify-center sm:justify-end">
              <div className="grid grid-rows-4  lg:grid-flow-col  sm:grid-flow-row ">
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Төсвийн нэр:</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                  <input
                      ...
                      onChange={(e) => {
                        let temp = data;
                        temp.BUDGET_NAME = e.target.value;
                        loadData({
                          ...temp,
                        });
                      }}
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Төсвийн төрөл:</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                    <select
                      ...
                      value={data.BUDGET_LEVEL_ID}
                      onChange={(value) => {
                        let temp = data;
                        temp.BUDGET_LEVEL_ID = value.target.value;
                        loadData({ ...temp });
                      }}
                    >
                      <option value={999}>Бүгд</option>
                      {drop.drop2.map((nation, index) => (
                        <option
                          className="font-semibold"
                          key={nation.BUDGET_LEVEL_NAME}
                          value={nation.BUDGET_LEVEL_ID}
                        >
                          {nation.BUDGET_LEVEL_NAME}
                        </option>
                      ))}
                    </select>
                  </div>
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Дүгнэлтийн хэлбэр:</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                    <select
                      ...
                      value={data.CONCLUSION_FORM_ID}
                      onChange={(value) => {
                        let temp = data;
                        temp.CONCLUSION_FORM_ID = value.target.value;
                        loadData({ ...temp });
                      }}
                    >
                      <option value={999}>Бүгд</option>
                      {drop.drop3.map((nation, index) => (
                        <option
                          className="font-semibold"
                          key={nation.CONCLUSION_FORM_NAME}
                          value={nation.CONCLUSION_FORM_ID}
                        >
                          {nation.CONCLUSION_FORM_NAME}
                        </option>
                      ))}
                    </select>
                  </div>
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Тусгасан эсэх:</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                    <select
                      ...
                      value={data.IS_REFLECT}
                      onChange={(value) => {
                        let temp = data;
                        temp.IS_REFLECT = value.target.value;
                        loadData({ ...temp });
                      }}
                    >
                      <option value={999}>Бүгд</option>
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Дүгнэлтийн төрөл:</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                    <select
                      ...
                      value={data.CONCLUSION_TYPE_ID}
                      onChange={(value) => {
                        let temp = data;
                        temp.CONCLUSION_TYPE_ID = value.target.value;
                        loadData({ ...temp });
                      }}
                    >
                      <option value={999}>Бүгд</option>
                      {drop.drop4.map((nation, index) => (
                        <option
                          className="font-semibold"
                          key={nation.CONCLUSION_TYPE_NAME}
                          value={nation.CONCLUSION_TYPE_ID}
                        >
                          {nation.CONCLUSION_TYPE_NAME}
                        </option>
                      ))}
                    </select>
                  </div>
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Үр өгөөжийн төрөл:</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                    <select
                      ...
                      value={data.BENEFIT_TYPE_ID}
                      onChange={(value) => {
                        let temp = data;
                        temp.BENEFIT_TYPE_ID = value.target.value;
                        loadData({ ...temp });
                      }}
                    >
                      <option value={999}>Бүгд</option>
                      {drop.drop5.map((nation, index) => (
                        <option
                          className="font-semibold"
                          key={nation.BENEFIT_TYPE_NAME}
                          value={nation.BENEFIT_TYPE_ID}
                        >
                          {nation.BENEFIT_TYPE_NAME}
                        </option>
                      ))}
                    </select>
                  </div>
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-md">Санхүүгийн үр өгөөжийн дүн(төгрөг):</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                  <CurrencyInput
                      ...
                      value={data.BENEFIT_FIN_AMOUNT}
                      decimalsLimit={2}
                      decimalScale={2}
                      onValueChange={(value, name) => {
                        let temp = data;
                        temp.BENEFIT_FIN_AMOUNT = value
                        loadData({
                          ...temp,
                        });
                      }}
                ...
                <div className="flex space-x-4 space-x-reverse h-10 my-1">
                  <div className="w-6/12">
                    <label className="block md:text-right md:mb-10  pr-6">
                      <span className="text-xs">Санхүүгийн бус үр өгөөжийн дүн(төгрөг):</span>
                    </label>
                  </div>
                  <div className="w-6/12 ">
                  <CurrencyInput
                      ...
                      value={data.BENEFIT_NONFIN_AMOUNT}
                      decimalsLimit={2}
                      decimalScale={2}
                      onValueChange={(value, name) =>{
                        let temp = data;
                        temp.BENEFIT_NONFIN_AMOUNT = value;
                        loadData({
                          ...temp,
                        });
                      }}
...
export default Mayagt_11_Create;
