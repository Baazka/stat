  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        cell: (info) => info.getValue(),
        header: "Орлого бүрдүүлэлттэй холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "ORLOGO_BURDUULELTTEI_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Орлого бүрдүүлэлттэй холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "TOSWIIN_TOLOWLOLT_GUITSETGEL_HOLBOOTOI_TOO",
        cell: (info) => info.getValue(),
        header: "Төсвийн төлөвлөлт, гүйцэтгэлтэй холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
        size: 250,
      },
      {
        ...
        cell: (info) => info.getValue(),
        header: "өсвийн төлөвлөлт, гүйцэтгэлтэй холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
        size: 250,
      },
      {
        ...
        cell: (info) => info.getValue(),
        header: "Нягтлан бодох бүртгэл, тайлагналтай холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "NBB_TAILAGNALTTAI_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Нягтлан бодох бүртгэл, тайлагналтай холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AHUA_UR_NOLOOTEI_HOLBOOTOI_TOO",
        cell: (info) => info.getValue(),
        header: "Арвилан хэмнэлт, үр ашиг, үр нөлөөтэй холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AHUA_UR_NOLOOTEI_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Арвилан хэмнэлт, үр ашиг, үр нөлөөтэй холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HTH_HOLBOOTOI_TOO",
        cell: (info) => info.getValue(),
        header: "Хууль тогтоомжийн хэрэгжилттэй холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HTH_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Хууль тогтоомжийн хэрэгжилттэй холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "DHH_HOLBOOTOI_DOO",
        cell: (info) => info.getValue(),
        header: "Дотоод хяналт, хариуцлагатай холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "DHH_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Дотоод хяналт, хариуцлагатай холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HA_HOLBOOTOI_TOO",
        cell: (info) => info.getValue(),
        header: "Худалдан авалттай холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HA_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Худалдан авалттай холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "ZBZ_HOLBOOTOI_TOO",
        cell: (info) => info.getValue(),
        header: "Зориулалт бус зарцуулалттай холбоотой зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "ZBZ_HOLBOOTOI_DUN",
        cell: (info) => info.getValue(),
        header: "Зориулалт бус зарцуулалттай холбоотой зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "BUSAD_TOO",
        cell: (info) => info.getValue(),
        header: "Бусад зөрчлийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "BUSAD_DUN",
        cell: (info) => info.getValue(),
        header: "Бусад зөрчлийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
    ],
    []
