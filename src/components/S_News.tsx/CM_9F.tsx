  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Сонин, сэтгүүл дээрх мэдээллийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Радио, телевизийн мэдээ, нэвтрүүлэг дээрх мэдээллийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Олон нийтийн сүлжээн дэх (Facebook, Twitter) мэдээллийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл, боловсруулсан тайлангийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл, боловсруулсан тайлангийн хуудасны тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл, хувилсан тайлангийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл, хувилсан тайлангийн хуудасны тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Цахим сайтын хандалтын тоо",
        footer: (props) => props.column.id,
      },
    ],
    []
