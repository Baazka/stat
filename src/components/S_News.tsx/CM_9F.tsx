...
function CM_9F() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_CM9F, any>[]>(
    () => [
      {
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Сонин, сэтгүүлийн мэдээллийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Радио, телевизийн мэдээ, нэвтрүүлгийн  мэдээллийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Олон нийтийн сүлжээний (Facebook, Twitter) мэдээллийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл тайлангийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл тайлангийн хуудасны тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл тайланг хувилсан тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын хэвлэмэл тайланг хувилсан хуудасны тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын цахимжуулсан тайлангийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Аудитын цахимжуулсан тайлангийн хуудасны тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Цахим сайтын хандалт",
        footer: (props) => props.column.id,
      },
    ],
    []
  ...
  let Stat_CM9F = [{}];
  const [data, setData] = React.useState<Stat_CM9F[]>(Stat_CM9F);
    ...
    <>
      ...
      >
        <div className="justify-start flex mb-2 mt-2">
          <Title
            title={
              "ТӨРИЙН АУДИТЫН БАЙГУУЛЛАГЫН МЭДЭЭЛЛИЙН ИЛ ТОД БАЙДАЛ 3-ТАБСМ-9Е"
            }
            widthS={"40rem"}
            widthL={"11rem"}
          />
          <div className="mt-1 ml-1.5">
            <Subtitle mayagtName={"З-ТАБСМ-9Е"} />
          </div>
        </div>
