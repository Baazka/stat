  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Төрийн аудитын байгууллагад 0-5 жил ажилласан",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Төрийн аудитын байгууллагад 6-10 жил ажилласан",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Төрийн аудитын байгууллагад 11-15 жил ажилласан",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Төрийн аудитын байгууллагад 16 болон түүнээс дээш жил ажилласан",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Тусгай мэргэжлийн дунд",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Техникийн болон мэргэжлийн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Бүрэн дунд, түүнээс доош",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Нягтлан бодогч",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
