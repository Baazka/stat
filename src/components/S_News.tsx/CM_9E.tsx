...
function CM_9E() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_CM9E, any>[]>(
    () => [
      {
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Дотоод сургалтын нийт тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Дотоод сургалтад хамрагдсан нийт албан хаагчдын тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Бусад байгууллагаас зохион байгуулсан сургалтын тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
  ...
  let Stat_CM9E = [{}];
  const [data, setData] = React.useState<Stat_CM9E[]>(Stat_CM9E);
    ...
    <>
      ...
      >
        <div className="justify-start flex mb-2 mt-2">
          <Title
            title={
              "ТӨРИЙН АУДИТЫН БАЙГУУЛЛАГЫН ДОТООД СУРГАЛТ, ХӨГЖЛИЙН ҮЙЛ АЖИЛГААНЫ ХЭРЭГЖИЛТ 3-ТАБСМ-9Д"
            }
            widthS={"53rem"}
            widthL={"16rem"}
          />
          <div className="mt-1 ml-1.5">
            <Subtitle mayagtName={"З-ТАБСМ-9Д"} />
          </div>
        </div>
