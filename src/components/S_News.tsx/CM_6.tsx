  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        accessorKey: "BUH_DUN",
        cell: (info) => info.getValue(),
        header: "Нийт дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HERGJSEN_OMNOH_ONI_TOO",
        cell: (info) => info.getValue(),
        header: "Өмнөх оны хэрэгжилтийн тоо",
        footer: (props) => props.column.id,
      },
      {
      ...
      },
      {
        ...
        cell: (info) => info.getValue(),
        header: "Өмнөх оны хэрэгжилтийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HEREGJSEN_TAILANT_ONI_TOO",
        cell: (info) => info.getValue(),
        header: "Тайлант оны хэрэгжилтийн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "HEREGJSEN_TAILANT_ONI_DUN",
        cell: (info) => info.getValue(),
        header: "Тайлант оны хэрэгжилтийн дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
      ...
      },
      {
        ...
        cell: (info) => info.getValue(),
        header: "Өмнөх оны хэрэгжээгүй дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
      {
      ...
      },
      {
        ...
        cell: (info) => info.getValue(),
        header: "Тайлант оны хэрэгжээгүй дүн /сая төгрөгөөр/",
        footer: (props) => props.column.id,
      },
    ],
    []
