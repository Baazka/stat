...
function CM_9B() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_CM9B, any>[]>(
    () => [
      {
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Тайлант оны төсвийн төлөвлөлт",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Тайлант оны төсвийн гүйцэтгэл",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "25 хүртэлх насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "25-29 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "30-34 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "35-39 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "40-44 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "45-49 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "50-54 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "55-59 насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "60, түүнээс дээш насны нийт албан хаагчид",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
  ...
  let Stat_CM9B = [{}];
  const [data, setData] = React.useState<Stat_CM9B[]>(Stat_CM9B);
    ...
    <>
      ...
      >
        <div className="justify-start flex mb-2 mt-2">
          <Title
            title={"ТӨРИЙН АУДИТЫН БАЙГУУЛЛАГЫН ХҮНИЙ НӨӨЦ 3-ТАБСМ-9Б"}
            widthS={"30rem"}
            widthL={"10rem"}
          />
          <div className="mt-1 ml-1.5">
            <Subtitle mayagtName={"З-ТАБСМ-9Б"} />
          </div>
        </div>
