...
function CM_8() {
  ...
  const columns = React.useMemo<ColumnDef<Stat_CM8, any>[]>(
    () => [
      {
      ...
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Өгсөн дүгнэлтийн нийт дүн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Орлого нэмэгдүүлсэн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Орлого нэмэгдүүлсэн дүн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Зарлагыг бууруулсан тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Зарлагыг бууруулсан дүн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Үр ашгийг дээшлүүлсэн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Үр ашгийг дээшлүүлсэн дүн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Тусгай дүгнэлтийн нийт тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Тусгай дүгнэлтийн нийт дүн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Орлого нэмэндүүлсэн тоо",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
        cell: (info) => info.getValue(),
        header: "Орлого нэмэндүүлсэн дүн",
        footer: (props) => props.column.id,
      },
      {
        accessorKey: "AUDIT_KOD",
  ...
  let Stat_CM8 = [{}];
  const [data, setData] = React.useState<Stat_CM8[]>(Stat_CM8);
    ...
    <>
      ...
      >
        <div className="justify-start flex mb-2 mt-2">
          <Title
            title={"ТӨСВИЙН ТӨСӨЛД ӨГСӨН ДҮГНЭЛТ 3-ТАБСМ-8"}
            widthS={"24rem"}
            widthL={"6rem"}
          />
          <div className="mt-1 ml-1.5">
            <Subtitle mayagtName={"З-ТАБСМ-8"} />
          </div>
        </div>
